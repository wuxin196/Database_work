...
void QlManager::insert_into(const std::string &tab_name, std::vector<Value> values, Context *context){
    auto exec = std::make_unique<InsertExecutor>(
        sm_manager_,
        tab_name,
        std::move(values),
        context
...
void QlManager::delete_from(const std::string &tab_name, std::vector<Condition> conds, Context *context){
    auto scan_exec = std::make_unique<SeqScanExecutor>(
        sm_manager_,
        tab_name,
        conds,
        context
    ...
    auto delete_exec = std::make_unique<DeleteExecutor>(
        sm_manager_,
        tab_name,
        conds,
        rids,
...
void QlManager::update_set(const std::string &tab_name, std::vector<SetClause> set_clauses,std::vector<Condition> conds, Context *context){
    ...
    auto update_exec = std::make_unique<UpdateExecutor>(
        sm_manager_,
        tab_name,
        set_clauses,
        conds,
